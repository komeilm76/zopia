...
| T-9 | **Option `useComponentAsReference: boolean`** — endpoints import emitted components recursively; requires `insertComponents: true`; **default `false`** | [Components → option matrix](08-components.md) | ✅ |

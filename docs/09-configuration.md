...
| `useComponentAsReference` | `boolean` | `false` | T-9 — imports exact component schema references in endpoints; nested/cyclic imports remain pending; **requires** `insertComponents: true` |

...
- 🧩 JSON Schema object conversion now approximates `patternProperties`, `propertyNames`, `minProperties`, and `maxProperties` with visible Zod catchall/refinement code; array `uniqueItems` and `contains` constraints are also emitted as refinements.

...
- 🧩 Object components now import direct array-item references used by nested properties and recursively render nested object/array reference trees, including lazy root schemas for direct self-cycles.

...
- 📚 Documented the current component-import limitation and explicit failure behavior across the README, concepts, usage, configuration, targets, and testing guides.

...
- 🧩 Object components now import direct array-item references used by nested properties and recursively render nested object/array reference trees, additional-property schemas, correct strict/passthrough object behavior, lazy root schemas for direct self-cycles, lazy references for mutual component cycles, nested `oneOf`/`anyOf`/`allOf` compositions, nullable schemas, enums, and constants; corresponding component documentation was updated.

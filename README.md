...
- 🧩 **Component options** — `insertComponents` and recursive endpoint component-reference imports are implemented; direct self-cycles use lazy schemas, while mutual cyclic imports remain a follow-up
